        ...
        <div class="pad20">
        	...
        	<form action="" method="post" enctype="application/x-www-form-urlencoded">
            	<fieldset>
                    ...
                    <p>
                    	<label for="account_id">帐号ID</label>
                        <input name="account_id" type="text" class="lf" id="account_id" value="<?php echo $account_id; ?>" />
                    </p>
                    <p>
                    	<label for="account_name">帐号名</label>
                        <input name="account_name" type="text" class="lf" id="account_name" value="<?php echo $account_name; ?>" />
                    </p>
                    <p>
        	...
        	<table class="fullwidth" cellpadding="0" cellspacing="0" border="0">
                ...
                <?php if(!empty($result)): ?>
                    ...
                    <tr<?php if($i%2==0): ?> class="odd"<?php endif; ?>>
                        ...
                        <td><?php echo lang('recharge_log_type_' . $result[$i]->funds_type); ?></td>
                        <td><?php echo intval($result[$i]->funds_amount) / 100; ?></td>
                        <td><?php echo $result[$i]->funds_item_amount; ?></td>
                        <td><?php echo $result[$i]->funds_time_local; ?></td>
                    </tr>
                    <?php endfor; ?>
                <?php else: ?>
                	<tr>
