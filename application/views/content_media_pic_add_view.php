        ...
        <div class="pad20">
            ...
            <form method="post" action="<?php echo $root_path ?>content/media/submit">
                ...
                <fieldset>
                    ...
                    <p>
                        <label for="mediaUrl">上传图片</label>
                        <input name="mediaUrl" type="file" id="mediaUrl" size="20" class="text-input" />
                        <input type="button" name="btn_upload" id="btn_upload" value="上传" onclick="javascript:contentPicUpload('mediaUrl')" class="button" />
                        <input type="hidden" id="mediaUrlContainer" name="mediaUrlContainer" value="<?php echo $media_url; ?>" />
                        <div id="mediaUrl_displayer"></div>
                    </p>
                    <p>
                    ...
                    <p>
                    	<label for="mediaType">类型</label>
                        <select id="mediaType" name="mediaType">
                        	<option value="3" <?php if($media_type=='3'): ?>selected="selected"<?php endif; ?>>截图</option>
                            <option value="2" <?php if($media_type=='2'): ?>selected="selected"<?php endif; ?>>原画</option>
                        </select>
                    </p>
                    <p>
                        <label>描述</label>
                        <textarea name="mediaComment" id="mediaComment" class="lf" cols="80" rows="4"><?php echo $media_comment; ?></textarea>
                    </p>
                    <p>
