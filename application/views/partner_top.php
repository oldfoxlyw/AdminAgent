<div id="header">
    ...
    <div id="top">
        <!-- Logo -->
        <div class="logo"> 
            <a href="<?php echo $root_path; ?>" title="管理首页" class="tooltip"><img src="<?php echo $root_path; ?>resources/assets/logo1.png" alt="Wide Admin" /></a> 
        </div>
        <!-- End of Logo -->
        ...
        <div class="meta">
            ...
            <ul>
                <li><a href="<?php echo $root_path; ?>partner/login/out" title="退出登录" class="tooltip"><span class="ui-icon ui-icon-power"></span>退出登录</a></li>
                <!--
