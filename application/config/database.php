...
$db['webdb']['database'] = 'agent_web_db';
...
$db['logdb']['database'] = 'agent_log_db_201201';
$db['logdb']['dbdriver'] = 'mysqli';
$db['logdb']['dbprefix'] = '';
$db['logdb']['pconnect'] = TRUE;
...
$db['adminlog']['database'] = 'agent_adminlog_db';
$db['adminlog']['dbdriver'] = 'mysqli';
$db['adminlog']['dbprefix'] = '';
$db['adminlog']['pconnect'] = TRUE;
...
$db['logcachedb']['database'] = 'agent_log_db';
