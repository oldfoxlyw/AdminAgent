...
class Recharge_log extends CI_Controller {
	private $user = null;
	private $_CONFIG = null;
	private $permissionName = 'report_recharge_log';
	...
	public function __construct() {
		...
		$this->load->model('report/funds');
		$this->lang->load('recharge_log');
	...
	public function index() {
		...
		if($flag=='1') {
			 ...
			 * @novar
			 */
			$rowTotal = $this->funds->getTotal($parameter);
			...
			$result = $this->funds->getAllResult($parameter, $itemPerPage, $offset);
		...
		$this->render->render('report_recharge_log', $data);
	}
}
?>